              ...
              <table cellspacing="0" cellpadding="0" width="530" height="303" class="w320">
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="303">
                    ...
                    <h1 style="text-transform: uppercase; color:#fff;">bienvenue à nouveau '.$name_recepteur.' !</h1>
                    <h2 style="text-transform: uppercase; color:#fff;">Rénitialisation du mot de passe</h2>
            ...
            <table cellspacing="0"  cellpadding="30" width="500" class="w320">
              <tr>
                <td valign="top" style="border-bottom:1px solid #a1a1a1;">
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      <td style="text-align: center; color:#1dabc5; font-weight:bold;">
                        <h3>Le mot de passe de votre compte est confidentiel, garde-le en sécurité !</h3>
                        <br>
                      </td>
                    </tr>
                  </table>
                  ...
                  <center>
                  <table style="margin: 0 auto;" cellspacing="0" cellpadding="8" width="auto">
                    <tr>
                      <td style="border: 1px solid #a1a1a1; text-align:center; ">
                        Mot de passe : <span style="font-family: Courier;">'.$mot_de_passe.'</span>
                      </td>
                    </tr>
                  </table>
                  </center>
